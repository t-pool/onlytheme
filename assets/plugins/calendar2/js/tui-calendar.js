...
/**
 * Trim leading, trailing #42364espace
...
var theme = {
    ...
    'common.backgroundColor': '#42364e',
    'common.holiday.color': '#ff4040',
    'common.saturday.color': '#8a7b97',
    'common.dayname.color': '#8a7b97',
    'common.today.color': '#8a7b97',
    ...
    'month.moreView.backgroundColor': '#42364e',
 ...
 * @example
 ...
 var themeConfig = {
    ...
    'month.moreViewTitle.height': '44px',
    'month.moreViewTitle.marginBottom': '12px',
    'month.moreViewTitle.backgroundColor': '#42364e',
    'month.moreViewTitle.borderBottom': 'none',
    'month.moreViewTitle.padding': '12px 17px 0 17px',
    ...
    'week.pastTime.color': '#8a7b97',
    'week.pastTime.fontWeight': 'normal',

    'week.futureTime.color': '#8a7b97',
...
var themeConfig = {
    ...
    'week.timegridLeftAdditionalTimezone.backgroundColor': '#42364e',
...
TimeGrid.prototype._getStyles = function(theme, timezonesCollapsed) {
    ...
    if (theme) {
        ...
        styles.displayTimezoneLabelBackgroundColor = theme.week.timegridLeft.backgroundColor === 'inherit' ? '#42364e' : theme.week.timegridLeft.backgroundColor;
